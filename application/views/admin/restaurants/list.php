                        ...
                        <td>
                            <div class="text-right">
                                <div class="btn-group">
                                    ...
                                    <a href="employee/by_restaurant/<?php echo $restaurant['id']; ?>" class="btn btn-info btn-xs" title="<?php echo lang('admin button edit'); ?>"><span class="glyphicon glyphicon-user"></span></a>
                                </div>
                            </div>
                        </td>
                    </tr>
